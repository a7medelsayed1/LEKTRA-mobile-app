...
class DioProvider {
  ...
  Future<dynamic> bookAppointment(
      String date, String day, String time, String doctor, String token) async {
    try {
      var response = await http.post(Uri.parse(bookAppointmentURL),
          body: {'date': date, 'day': day, 'time': time, 'doctor_id': doctor},
